...
export const EventsWithCalendar = ({ group, currentUser, isGroupMember }: EventsProps) => {
  ...
  // Convert GroupEvent to CalendarEventType for the Calendar component
  ...
  return (
    ...
    >
      ...
      {/* Calendar View - Using the new standalone Calendar component */}
      {viewType === "calendar" && (
        <Calendar 
          events={calendarEvents} 
          onAddEvent={isGroupMember ? handleAddEvent : undefined}
          canAddEvent={isGroupMember}
        />
      )}
